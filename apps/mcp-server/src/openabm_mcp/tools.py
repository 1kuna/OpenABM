...
TOOL_DEFINITIONS: list[dict[str, Any]] = [
    ...
    _tool(
        "list_deployment_contexts",
        "List deployment provenance records for a project.",
        _schema(
            ["project_id"],
            {"project_id": STRING, "environment": NULLABLE_STRING, "limit": LIMIT},
        ),
        scopes=READ_TRACE_SCOPE,
        example_request={"project_id": "proj_demo", "environment": "prod"},
        example_response={"data": []},
    ),
    _tool(
        "get_deployment_context",
        "Fetch one deployment provenance record.",
        _schema(
            ["project_id", "deployment_context_id"],
            {"project_id": STRING, "deployment_context_id": STRING},
        ),
        scopes=READ_TRACE_SCOPE,
        example_request={
        ...
        example_response={"deployment_context_id": "deploy_refund_runtime_v2"},
    ),
    _tool(
        "register_deployment_context",
        "Register or refresh deployment provenance metadata.",
        _schema(
            [
                "project_id",
            ...
            ],
            {
                ...
                "branch_nullable": NULLABLE_STRING,
                "build_id_nullable": NULLABLE_STRING,
                "deploy_id_nullable": NULLABLE_STRING,
                "runtime_nullable": NULLABLE_STRING,
                "environment": STRING,
                "created_at": STRING,
            },
        ),
    ...
    _tool(
        "list_code_contexts",
        "List source/code provenance records for a project, trace, or span.",
        _schema(
            ["project_id"],
            {
                "project_id": STRING,
    ...
    _tool(
        ...
        example_response={"code_context_id": "code_context_123"},
    ),
    _tool(
        "register_code_context",
        "Register or refresh source/code provenance for a trace or span.",
        _schema(
            ["project_id", "code_context_id", "trace_id", "created_at"],
            {
                "project_id": STRING,
                "code_context_id": STRING,
                "trace_id": STRING,
                "span_id_nullable": NULLABLE_STRING,
                "file_path_nullable": NULLABLE_STRING,
                "function_name_nullable": NULLABLE_STRING,
                "line_start_nullable": {"type": ["integer", "null"]},
                "line_end_nullable": {"type": ["integer", "null"]},
        ...
        example_request={
            "project_id": "proj_demo",
            "code_context_id": "code_context_123",
    ...
    _tool(
        "notify_affected_entity",
        "Send, preview, or queue a remediation notification for an affected entity.",
        _schema(
            ["project_id", "affected_entity_id", "target_id"],
            {
                "project_id": STRING,
                "affected_entity_id": STRING,
                "target_id": STRING,
                ...
                "group_key": NULLABLE_STRING,
                "idempotency_key": NULLABLE_STRING,
            },
        ),
        scopes=WRITE_INVESTIGATION_SCOPE + ["notifications:write"],
        side_effects=True,
        confirmation_required=True,
        example_request={
            "project_id": "proj_demo",
            "affected_entity_id": "affected_entity_123",
            "target_id": "notification_target_123",
            "delivery_mode": "preview",
            "confirmed": True,
        },
        example_response={"notification": {"delivery_status": "preview_only"}},
    ),
    _tool(
        "get_agent_context_pack",
